...
%At this point I studied in Berlin, Milan, Turin, and Vancouver (cities having different traffic patterns) different electric FFCS setup. I showed that placing the charging station where the users ends the rental most frequently and makes the system sustainable with few charging stations (8-10~\% of city zones). Finally, I investigate different charging station setups. The best results come by balancing the spread of charging stations.
%concentrated all plugs in a unique hub or spread them all above the city leads to poor performances in terms of system sustainability and user's discomforts.
