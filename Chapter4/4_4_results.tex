...
\begin{figure}
	\centering
	\subfloat[\centering Two-way Modo Weekdays]{{\includegraphics[width=0.46\columnwidth]{modo_inTravel/weekdays.pdf}} \label{fig:4_4_modo_wd}}%
	\qquad
	\subfloat[\centering Two-way Modo Weekends]{{\includegraphics[width=0.46\columnwidth]{modo_inTravel/weekends.pdf}} \label{fig:4_4_modo_we}}%
...
\begin{figure}
	\centering
	\subfloat[\centering One-way Evo Weekdays]{{\includegraphics[width=0.46\columnwidth]{evo_inTravel/weekdayslim.pdf}} \label{fig:4_4_evo_wd}}%
	\qquad
	\subfloat[\centering One-way Evo Weekends]{{\includegraphics[width=0.46\columnwidth]{evo_inTravel/weekendslim.pdf}} \label{fig:4_4_evo_we}}%
...
\begin{figure}
	\centering
	\subfloat[\centering Free floating car2Go Weekdays]{{\includegraphics[width=0.46\columnwidth]{car2go_inTravel/weekdayslim.pdf}} \label{fig:4_4_c2g_wd}}%
	\qquad
	\subfloat[\centering Free floating car2Go Weekends]{{\includegraphics[width=0.46\columnwidth]{car2go_inTravel/weekendslim.pdf}} \label{fig:4_4_c2g_we}}%
