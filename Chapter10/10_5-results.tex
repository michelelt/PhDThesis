...
There is still a 5-7\% of unsatisfied demand which results from the mismatch between zones with available cars, and zones with demand. I now check the impact of $z_p$ on this.
...
%It is quite a result because I can face a quintupled demand doubling our fleet. Indeed, there seems to be a value for the number of poles that guarantees that specific fraction of unsatisfied users. After reaching this number of poles if I keep on increasing one of the two parameters I can not appreciate any differences in terms of this performance metric. 
